 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |  OS  | Alt  | Tab  | Lower| Raise| Space| Mouse| Raise| Lower| Left | Down |Right |
 * `-----------------------------------------|-----------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  KC_LGUI, KC_LALT, KC_TAB,  LOWER,   RAISE,   KC_SPC,  MOUSE,   RAISE,   LOWER,   KC_LEFT, KC_DOWN, KC_RGHT \
),
/* Lower
 * ,-----------------------------------------|-----------------------------------------.
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
